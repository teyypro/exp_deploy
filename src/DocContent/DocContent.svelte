<script>
    import IllustrateImg from "../DaskBoard/illustrateIMG/illustrateIMG.svelte";
...
// Cuộn xuống toàn bộ chiều cao của phần tử 'contentDoc' với hành vi cuộn mượt mà
document.getElementById('contentDoc').scrollBy({ top: document.getElementById('needscroll').scrollHeight*0.45, behavior: 'smooth' });
}
  </script>
<div id ='contentDoc'>
    <div id = 'taskbar' in:slide ={{duration:1000}}>
       <Logo/>
       <button id = 'license' on:click={()=>{window.open("http://localhost:1805/#/license")}}>License</button>
        <button on:click = {store} class="material-symbols-outlined" id = 'storelink'>
            archive
        </button>
    </div>
    ...
    <div class ='containdoc' style = 'height:max-content;' id = "needscroll">
        <div id = 'contaidoc1part2'>
            <div>
            <div id = 'premess'>Find what's in this magical tool✌️👻</div>
            <div  id = 'pdfbut' class = 'choice' >
                ...
                <button on:click ={()=>{window.open('http://localhost:1805/#/reading', '_blank');}}  class = 'deploy' ><span class="material-symbols-outlined">
                    token
                    </span>deploy</button>
            </div>
            <div  id = 'listbut' class = 'choice' >
                ...
                <button on:click ={()=>{window.open('http://localhost:1805/#/listening', '_blank');}}  class = 'deploy' ><span class="material-symbols-outlined">
                    token
                    </span>deploy</button>
            </div>
            </div>
        ...
        ">
            <div  id = 'revibut'class = 'choice' >
                ...
                <button on:click ={()=>{window.open('http://localhost:1805/#/reviving', '_blank');}}  class = 'deploy' ><span class="material-symbols-outlined">
                    token
                    </span>deploy</button>
            </div>
            <div  id = 'game' class = 'choice' >
                ...
                <button on:click ={()=>{window.open('http://localhost:1805/#/speaking', '_blank');}}  class = 'deploy' ><span class="material-symbols-outlined">
                    token
                    </span>deploy</button>
            </div>
            </div>
...
<style>
    ...
    border-radius: 2vh;
    z-index: 999;
    box-shadow: rgba(3, 102, 214, 0.3) 0px 0px 0px 0.4vh;
    align-items: center;
    flex-direction: row;
...
#contaidoc1part1{
  ...
  #contentDoc::-webkit-scrollbar{
    width:1vh;
  }
  #contentDoc::-webkit-scrollbar-thumb{
    background-color:#535353;
  }
</style>